...
| message_type | 此元素说明该如何处理payload 信息。  <br>系统定义如下message_type ：  <br>1. **NBIRTH** –  设备测点信息，可初始化某Node 下所有设备信息和测点信息 <br>2. **NDATA** –  测点数据，发送某设备下测点数据 <br>3. **NCMD** –  测点命令，回写某设备下测点数据  |
