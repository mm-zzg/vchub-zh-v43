...
3. 在弹出的数据源窗口中，您将看到 OPC UA Server 的节点树。该树结构反映了服务器中的层次结构，包含所有可用的对象、目录和节点。
      ...
      a. 点击节点名前的展开按钮 ▶ 可以展开节点，查看其子节点。

      b. 单击您想要绑定的节点。选中后，该节点将被高亮显示，同时右侧窗口会更新显示该节点的相关属性信息。

      c. 如果所选节点是一个数组，您可以在右侧窗口的指定位置输入所需的下标来访问数组中的特定元素，在输入框中填写下标值，例如0则访问数组的第一个元素。
      ![alt text](22.png)
