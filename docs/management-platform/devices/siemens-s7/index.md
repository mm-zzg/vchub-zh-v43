...
WAGO SCADA中的西门子驱动程序支持与 S7 设备的基本连接。目前，WAGO  SCADA具有适用于以下西门子 PLC 的驱动程序：
...
| LReal              | 当变量的数据类型为Double 时，才显示该数据类型。  <br>**注意：**  <br>由于 Siemens 设备的限制，仅以下型号支持此数据类型：  <br>- S7-1200 <br>- S7-1500 |
