...
| W        | 控件的宽度，单位px。   |
| H        | 控件的高度，单位px。   |
| 场景     | 为控件绑定场景。  <br>![alt text](77.png)  <br>![alt text](78.png)  下拉选择已创建的场景 <br>![alt text](79.png)  刷新按钮，点击后对下拉列表内容进行刷新 <br>![alt text](80.png)  编辑按钮，点击后在新的浏览器窗口打开当前所选场景的编辑页面 <br>![alt text](81.png)  绑定按钮，点击后弹出属性绑定窗口，为控件绑定场景 |
