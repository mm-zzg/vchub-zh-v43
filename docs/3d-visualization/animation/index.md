...
WAGO  SCADA 中，当模型具有动画属性时，在右侧的属性栏中会显示“动画”一列，点击设置按钮可以进行动画设置。

![alt text](3d_Animation1.png)

## 动画类型

WAGO SCADA 的 3D 模型支持以下动画类型：
...
![alt text](../../assets/images/3d_Animation2.gif)
...
![alt text](../../assets/images/3d_Animation4.gif)
...
![alt text](../../assets/images/3d_Animation6.gif)
...
![alt text](../../assets/images/3d_Animation11.gif)
